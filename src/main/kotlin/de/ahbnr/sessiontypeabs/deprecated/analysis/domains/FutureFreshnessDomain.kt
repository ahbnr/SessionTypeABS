...
import de.ahbnr.sessiontypeabs.deprecated.analysis.exceptions.MergeException
    ...
    Finalizable<FutureFreshnessDomain>
{
     ...
     * Is invoked when applying the [transferType] relation on initialization and
     * interaction types.
     */
     ...
     * created during application of the [transferType] relation on an interaction or initialization .
     */
