...
fun checkModel(model: Model, typeBuild: TypeBuild, verificationConfig: VerificationConfig = VerificationConfig()) {
    ...
    val actorClassesMapping = ActorModelMapping(classDecls, sessionType, verificationConfig)

    checkMainBlock(model.mainBlock, sessionType, actorClassesMapping, verificationConfig)
